# Auto Test CRM — CLAUDE.md

> Bu fayl Claude Code uchun loyihaning "miyasi". Har bir sessiyada o'qiladi.
...
**IMPORTANT: Do not write any comments in code.** All documentation lives here in CLAUDE.md.
